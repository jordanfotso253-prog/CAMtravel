...
// Transmet toutes les informations du trajet vers la page des passagers
const nextParams = new URLSearchParams({ company, dep, arr, duration, price, tags: tags.join(','), from, to, date });
document.getElementById('continueBtn').href = `info-passager.html?${nextParams.toString()}`;
